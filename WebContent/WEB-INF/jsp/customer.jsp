		...
		<div class="panel panel-default">
			<div class="panel-body">
				<form class="form-inline" method="get" 
					...
					<div class="form-group">
						<label for="customerFrom">客户状态</label> 
						<select	class="form-control" id="customerFrom" name="custState">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="new_customer_form">
					...
					<div class="form-group">
						<label for="new_customerFrom" style="float:left;padding:7px 15px 0 27px;">客户状态</label> 
						<div class="col-sm-10">
							<select	class="form-control" id="new_customerFrom" name="cust_state">
								<option value="">--请选择--</option>
								<c:forEach items="${fromType}" var="item">
									<option value="${item.dict_id}"<c:if test="${item.dict_id == custSate}">selected</c:if>>
									${item.dict_item_name }									
									</option>
								</c:forEach>
							</select>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="edit_customer_form">
					...
					<div class="form-group">
						<label for="edit_customerFrom" style="float:left;padding:7px 15px 0 27px;">客户状态</label> 
						<div class="col-sm-10">
							<select	class="form-control" id="edit_customerFrom" name="cust_state">
								<option value="">--请选择--</option>
								<c:forEach items="${fromType}" var="item">
									<option value="${item.dict_id}"<c:if test="${item.dict_id == custstate}"> selected</c:if>>${item.dict_item_name }</option>
								</c:forEach>
							</select>
	...
	function editCustomer(id) {
	    $.ajax({
	        ...
	        success:function(data) {
	            ...
	            $("#edit_customerFrom").val(data.cust_state)
